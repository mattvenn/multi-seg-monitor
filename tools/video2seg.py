...
Output is raw frames of 5724 bytes, ready to copy to the demoboard.
...
def frame_to_segments(linear):
    ...
    rather than 10017 separate lookups.
    """
...
def main():
    ...
    ap.add_argument("output", help="raw segment stream, 5724 bytes per frame")
